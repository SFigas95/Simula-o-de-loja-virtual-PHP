...
<div class="container">
    ...
    <form action="introduzir_conta_externa.php" method="post">
        ...
        <div class="form-group">
            ...
            <input type="password" name="confirmar_password" class="form-control" placeholder="Confirmar Password" required autocomplete="off" oninput="validarpassword(this)">
